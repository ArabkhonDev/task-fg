        ...
        <div class="filter w-[380px] bg-green-500 h-[400px] m-3 p-2">
            ...
            <form action="#" method="GET">
                ...
                <label for="">Sub Category
                    <select name="#" id="" class="w-full m-1 rounded">
                        <option value="1">Php basic</option>
                        <option value="1">Js basic</option>
                        <option value="1">pyton basic</option>
                    </select>
                </label>
                ...
                <button type="submit" name="sort" class="w-full bg-green-400 p-3 rounded hover:bg-blue-500 hover:text-white-500">Show</button>
            </form>
        </div>
        <div class="posts ml-1 m-3">
            <div
                class="min-h-screen w-[900px] m-auto bg-gray-100  items-center justify-between -ml-[10px]">
                @foreach ($posts as $post)
                    <!-- component -->
                    <div class=" w-[900px] bg-white flex flex-wrap justify-between rounded-xl shadow-lg overflow-hidden  transition-all mb-2">
                        
                        <div class="p-5 flex-1 space-y-4 w-50 bg-blue-300">
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">{{ $post->title }}</h3>
                                <p class="text-gray-500 mt-1">{{ $post->region->name }}</p>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="items-center gap-1">
                                    ...
                                    <b class="text-sm text-gray-600 ml-1"><i class="bi bi-eye"></i> {{ $post->view_count ?? "12" }} </b>
                                </div>
                            </div>
